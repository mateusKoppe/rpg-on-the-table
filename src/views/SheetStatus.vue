<template>
  <div>
    ...
    <div class="SheetStatus__status">
      <VCard> <b>HP:</b> 14 / 20 </VCard>
      <VCard> <b>Exp:</b> 2000 </VCard>
    </div>
    <div class="SheetStatus__combat">
      <VCard title="AC"> 14 </VCard>
      <VCard title="Iniciative"> 3 </VCard>
      <VCard title="Speed"> 30 </VCard>
    </div>
    <VCard> <input type="checkbox" /> Inspiration </VCard>
